...
import { FaBuilding, FaHome, FaCity, FaMapMarkerAlt, FaMapSigns, FaBed, FaExpandArrowsAlt, FaDollarSign, FaTag, FaTools, FaShieldAlt } from 'react-icons/fa';
    ...
    return (
        <div className="bg-gray-100 p-5 rounded-lg shadow-lg max-w-4xl mx-auto my-10">
            ...
            (<form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <h2 className="text-2xl font-bold mb-6 text-center col-span-full">Post Your Property</h2>
                
                {/* Listing Type */}
                <div className="col-span-full bg-white p-3 rounded-lg">
                ...
                <button type="submit" className="bg-teal-500 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full col-span-full">Submit Property</button>
            </form>)}
        </div>
    );
};
